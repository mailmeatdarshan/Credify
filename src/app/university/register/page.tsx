        ...
        <div className="bg-white border border-[#EAE0CE] rounded-3xl p-8 sm:p-10 shadow-warm-md text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-[#716049] leading-relaxed max-w-md mx-auto">
              To register an issuing authority (University, Company, or Hackathon Organization) and provision cryptographic root keys, please sign in or create an account.
            </p>
          </div>
          ...
          <div className="pt-6 border-t border-[#EAE0CE] grid grid-cols-1 sm:grid-cols-3 gap-3 text-left">
            <div className="bg-[#FAF6EF] p-3 rounded-xl border border-[#EAE0CE]">
              <span className="text-[11px] font-bold text-[#141619] block">Zero-Trust PKI</span>
              <span className="text-[10px] text-[#716049]">Ed25519 &amp; ECC root keys</span>
            </div>
            <div className="bg-[#FAF6EF] p-3 rounded-xl border border-[#EAE0CE]">
              <span className="text-[11px] font-bold text-[#141619] block">Multi-Credential</span>
              <span className="text-[10px] text-[#716049]">Degrees, Internships, Awards</span>
            </div>
            <div className="bg-[#FAF6EF] p-3 rounded-xl border border-[#EAE0CE]">
              <span className="text-[11px] font-bold text-[#141619] block">Developer APIs</span>
              <span className="text-[10px] text-[#716049]">Embeddable verification</span>
            </div>
          </div>
        </div>
      </div>
